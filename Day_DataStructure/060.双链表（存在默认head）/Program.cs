...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        {
            DoubleLinkList dlink = new DoubleLinkList();// 创建双向链表
            ...
            dlink.Insert(1, 20);
            dlink.ShowAll();
            Console.WriteLine("将 30 插入到第2个位置之前");
            dlink.Insert(2, 30);
            dlink.ShowAll();
            Console.WriteLine("将 40 插入到第4个位置之前");
            dlink.Insert(4, 140);
            dlink.ShowAll();
            Console.WriteLine("将 40 插入到第4个位置之后");
            dlink.Append(4, 14520);
            dlink.ShowAll();
